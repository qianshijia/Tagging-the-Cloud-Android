...
public class HiddenCtl extends Activity implements OnClickListener
{
	private TextView tv;
	...
	public void onClick(View v) {
		...
		if(v.getId() == R.id.btnNext)
		{
			...
			intent.setClass(HiddenCtl.this, Processor.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
	    if (keyCode == KeyEvent.KEYCODE_BACK) {
	    	AlertDialog.Builder alertbox = new AlertDialog.Builder(HiddenCtl.this);
			...
			alertbox.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface arg0, int arg1) {
					...
					Intent intent = new Intent();
					intent.setClass(HiddenCtl.this, MainBarcodeActivity.class);
					startActivity(intent);
					finish();
				}
			});
