		...
		try {
			...
			NodeList node1 = nodeList.item(0).getChildNodes();
				...
				try {
					...
					NodeList firstnameList = doc.getElementsByTagName("mediaid");
					Node theNode = firstnameList.item(0);
					Log.i("mediaid==", theNode.getFirstChild().getNodeValue());
				Question.mediaId = theNode.getFirstChild().getNodeValue();
				} catch (Exception e) {
